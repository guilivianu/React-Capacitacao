...
export default function Home() {
  ...
  return (
    <main className="grid grid-rows-12 w-screen h-screen bg-gray-50 text-gray-600">
      ...
      {/* HEADER */}
      <div className="flex items-center bg-gray-100 border-b-4 border-gray-200 row-span-2">
      ...
      {/* BODY */}
      <div className="grid row-span-8 bg-gradient-to-br from-gray-50 to-cyan-100">
        {/* HOOKS */}
        <div className="container max-w-5xl mx-auto p-4 py-8 flex items-center row-span-4">
      ...
      {/* FOOTER */}
      <div className="flex items-center bg-gray-100 border-t-2 border-gray-200 align-bottom row-span-2">
        <div className="container max-w-5xl mx-auto px-4 h-24 flex items-center justify-between">
          <div className="font-bold text-gray-400 text-2xl">
            Capacitação em React, parte teórica
          </div>

          <div className="flex items-center text-gray-400 space-x-3">
            Desenvolvido por: Guilherme Livianu
          </div>
        </div>
      </div>
      {/* /FOOTER */}
