...
export default function UseState() {
  ...
  return (
    <main className="flex flex-col w-screen h-full bg-gradient-to-br from-purple-400 to-purple-800">
      ...
      <section className="bg-gray-100 border-b-4 border-gray-200  ">
        <div className="container max-w-5xl mx-auto p-4 gap-2 flex flex-col items-center justify-center">
          ...
          <button
            ...
            className="inline-flex items-center text-xs font-bold bg-purple-600 text-white px-3 py-2 rounded-full shadow hover:bg-purple-700 focus:outline-none active:bg-purple-800"
          >
            <svg
      ...
      <div className="container max-w-5xl mx-auto lg:flex-col lg:justify-center lg:gap-6 h-screen flex flex-col items-center justify-evenly">
